...
OUTPUT_DIR = CallTimePath("ORACLE_OUTPUT_DIR", lambda: _oracle_work_root() / "stage1_oracle_backends" / "beta")
CONFIG_PATH = CallTimePath("ORACLE_CONFIG", lambda: _project_root() / "contracts" / "oracle_components" / "beta" / "stage4_beta_config.yaml")
